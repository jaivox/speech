...
/**
 * Generate an answer indicating that the system is confused. Uses fields
 * defined in Answer.
 * @param net
 * @return
 */
	...
	String confusedAnswer (Semnet net) {
		String start = ans.selectPhrase (confused);
		String follow = ans.selectPhrase (followup);
		String topic = ans.selectPhrase (topics);
