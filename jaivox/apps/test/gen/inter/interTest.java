...
public class interTest extends Thread {
	...
	who1 = "{action: JviaWho, from: inter, to: asr, message: Jviawho}",
	who2 = "{action: JviaWho, from: inter, to: tts, message: Jviawho}";
...
// 		kv.setProperty ("answer_forms", "PATanswer_forms");
		...
		kv.setProperty ("recognizer", "asr");
		kv.setProperty ("interpreter", "inter");
		kv.setProperty ("synthesizer", "tts");
