...
import com.jaivox.synthesizer.web.SynthServer;
...
public class webTest extends Thread {
	...
	static String who1 = "send tts_0 {action: JviaWho, from: tts, to: inter, message: Jviawho}";
	...
	public static void main (String args []) {
		...
		kv.setProperty ("language", "en");

		try {
			Synth = new SynthServer ("tts", port, "./", kv);
