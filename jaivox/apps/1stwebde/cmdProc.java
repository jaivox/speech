 ...
 */
	void initializeQuants () {
		...
		// the adjectives are modified according to those used
		// in the specs (generally varies with the language)
		quants.put ("jjm-ns", new Point (0, 10));
		quants.put ("jje-ns", new Point (0, 10));
		quants.put ("jj-ns", new Point (0, 10));
		quants.put ("jjm-nr", new Point (0, 30));
		quants.put ("jje-nr", new Point (0, 30));
		quants.put ("jj-nr", new Point (0, 30));
		quants.put ("jjm-n",  new Point (0, 50));
		quants.put ("jje-n",  new Point (0, 50));
		quants.put ("jj-n",  new Point (0, 50));
		quants.put ("jjm-p",  new Point (50, 99));
		quants.put ("jj-p",  new Point (50, 99));
		quants.put ("jje-p",  new Point (50, 99));
		quants.put ("jjm-pr", new Point (70, 99));
		quants.put ("jje-pr", new Point (70, 99));
		quants.put ("jj-pr", new Point (70, 99));
		quants.put ("jjm-ps", new Point (90, 99));
		quants.put ("jje-ps", new Point (0, 10));
		quants.put ("jj-ps", new Point (0, 10));
	}
